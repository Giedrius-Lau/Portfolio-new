...
const Timeline = () => {
    ...
    return (
        <Section id='about'>
            ...
            <SectionTitle style={{ marginBottom: '30px' }}>About Me</SectionTitle>

            <SectionText style={{ marginBottom: '15px' }}>
                I'm a Front End Developer based in Lithuania 🌧️. I describe myself as a passionate developer who loves coding, and learning, or trying new
                technologies ❤️. Aside from my job, I like to workout 🏋️‍♂️, draw people ✍️, and watch tech front-end videos on youtube. That helps me to have a
                balanced life, and grow as a person.
            </SectionText>
